      ...
      <div className="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-vulcan-300">
            {strings(`features_description`) as string}
          </p>
        </div>
          ...
          {features.map((feature) => (
            <div key={feature.name} className="relative">
              <dt>
                ...
                <p className="ml-9 text-lg leading-6 font-medium text-vulcan-320">{strings(feature.name) as string}</p>
              </dt>
              <dd className="mt-2 ml-9 text-base text-vulcan-100">{strings(feature.description) as string}</dd>
            </div>
          ))}
        </dl>
